...
//  Les PRIX viennent de la grille Supabase (`tarifs`, éditable/importable) ; le
//  classement des prestations (macro-catégories, sections, unités) vit dans
//  `@/lib/devisCatalog`, partagé avec l'espace partenaire (/airbnb/devis).
