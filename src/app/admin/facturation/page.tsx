  ...
  return (
    <div className="p-4 md:p-6 max-w-4xl mx-auto">
      ...
      <div className="print-hidden">
        ...
        {/* Onglets. Les DEVIS ont leur propre écran (/admin/devis) : ils ont leur
            cycle de vie, leurs demandes entrantes et leur grille tarifaire — les
            garder ici obligeait à traverser la facturation pour y accéder. */}
        <div className="flex flex-wrap items-center gap-3 mb-6">
          <div className="flex gap-1 p-1 rounded-2xl w-fit" style={{ backgroundColor: '#F5F3EF' }}>
          ...
          <Link href="/admin/devis" className="text-sm font-semibold" style={{ color: '#C9A84C' }}>
            Devis et demandes →
          </Link>
        </div>
