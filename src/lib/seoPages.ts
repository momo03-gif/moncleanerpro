...
export const SEO_PAGES: SeoPage[] = [
  ...
  },
  {
    ...
    updatedAt: '2026-09-24',
    relatedPosts: ['changer-entreprise-nettoyage-sans-coupure'],
    cluster: 'communes',
    ...
    sections: [
      ...
      {
        h2: "Quand le rez-de-chaussée est commercial",
        paragraphs: [
          "Une bonne partie des immeubles du centre abrite des commerces en pied d’immeuble. Cela crée une configuration que les contrats d’entretien gèrent mal : un hall et des circulations qui relèvent de la copropriété, et une activité commerciale qui produit au même endroit des déchets, des livraisons et un passage bien supérieur à celui des résidents.",
          "Le point de friction est presque toujours le même — le local poubelles et le trajet qui y mène. Un commerce sort ses cartons et ses bacs aux horaires qui l’arrangent, la collecte passe à heure fixe, et entre les deux c’est la copropriété qui constate l’encombrement. Un contrat qui ne dit pas qui traite quoi, ni à quel moment, laisse le sujet se régler en assemblée générale.",
          "Nous le traitons dans le devis, pas après : ce qui relève du passage copropriété, ce qui relève d’une prestation propre au commerce, et à quels horaires chacune intervient pour ne pas se gêner. C’est une clarification de quelques lignes qui évite des mois de tension entre un syndic et son preneur.",
        ],
      },
    ],
    faq: [
      ...
      { q: 'Nous sommes une copropriété avec des commerces en rez-de-chaussée : est-ce un problème ?', a: "Non, à condition de le traiter dans le devis. Nous distinguons explicitement ce qui relève du passage de copropriété et ce qui relève d’une prestation propre au commerce, avec des horaires qui ne se gênent pas. Le point de friction est presque toujours le local poubelles et le trajet qui y mène." },
      { q: 'Pouvez-vous travailler avec le syndic et avec le commerçant séparément ?', a: "Oui, ce sont deux contrats distincts, avec chacun son périmètre et sa facturation. C’est plus clair pour tout le monde qu’une prestation unique dont personne ne sait exactement ce qu’elle couvre." },
      { q: 'Intervenez-vous avant l’ouverture d’un nouveau commerce ?', a: "Oui. La remise en état d’ouverture, une fois l’agencement terminé, est une prestation distincte de l’entretien courant : elle traite une salissure de chantier — poussière de découpe, adhésifs, protections de vitrine — que le contrat d’entretien n’absorbe pas." },
    ],
  ...
  },
  {
    ...
    sections: [
      ...
      {
        h2: "Réhabiliter une cage encore habitée",
        paragraphs: [
          "C’est la situation la plus fréquente sur le parc de la commune, et la plus mal traitée. Un immeuble en réhabilitation ne se vide pas : les locataires restent, l’escalier reste le seul accès, et les entreprises montent et descendent du matériel toute la journée. Le nettoyage ne peut donc pas attendre la fin des travaux — sinon les habitants vivent six mois dans la poussière, et c’est le gestionnaire qui reçoit les appels.",
          "Nous travaillons alors en deux temps distincts. Un passage de maintien en cours de chantier, resserré sur ce qui rend l’immeuble praticable : marches, mains courantes, paliers, sas d’entrée, boîtes aux lettres. Puis une remise en état complète une fois les entreprises parties, qui traite ce que le passage quotidien ne peut pas faire — points hauts, gaines, vitrages, résidus incrustés.",
          "La différence n’est pas qu’une question de propreté. Une marche couverte de poussière de plâtre devient glissante, et une cage d’escalier est le seul chemin d’évacuation de l’immeuble. C’est la raison pour laquelle nous tenons ce passage même les semaines où le chantier avance peu.",
        ],
      },
      {
        h2: "Ce que nous traitons sur le secteur",
        list: [
          "Parties communes de patrimoine bailleur : halls, escaliers, paliers, sous-sols",
          "Locaux poubelles et abords des points de collecte",
          "Immeubles en réhabilitation, occupés pendant les travaux",
          "Bureaux et commerces des programmes récents du Carré de Soie",
          "Vitrages de halls et façades intérieures, à fréquence propre",
          "Logements remis en état avant relocation",
        ],
      },
    ],
    faq: [
      ...
      { q: 'Pouvez-vous intervenir pendant les travaux, immeuble occupé ?', a: "Oui. Nous assurons un passage de maintien sur les circulations — marches, mains courantes, paliers, sas — tant que le chantier dure, puis la remise en état complète une fois les entreprises parties. C’est un sujet de sécurité autant que de propreté : une marche chargée de poussière de plâtre devient glissante." },
      { q: 'Combien d’entrées pouvez-vous couvrir sur une même tournée ?', a: "Nous organisons des tournées par secteur plutôt qu’adresse par adresse. Le nombre d’entrées dépend des prestations retenues sur chacune ; nous le calons sur votre patrimoine réel lors du devis." },
      { q: 'Le vitrage est-il compris dans un contrat de parties communes ?', a: "Nous le chiffrons à part, avec sa propre fréquence. Compté dans un forfait au mètre carré de sol, il est systématiquement sous-dimensionné — or une trace sur un vitrage de hall se voit de l’extérieur, à contre-jour." },
    ],
  ...
  },
  {
    ...
    sections: [
      ...
      {
        h2: "Les locaux sociaux, ceux dont vos équipes parlent vraiment",
        paragraphs: [
          "Vestiaires, réfectoire, sanitaires d’atelier : dans la plupart des contrats, ces locaux sont traités en fin de passage, avec le temps qui reste. C’est exactement l’inverse de ce qu’il faudrait faire. Un salarié juge l’entretien de son entreprise sur l’état de son vestiaire et de sa salle de pause, pas sur celui du couloir de direction.",
          "Ces pièces concentrent aussi les vraies difficultés techniques. Un vestiaire d’atelier reçoit de l’humidité, des vêtements de travail chargés et un sol qui reste mouillé : c’est un terrain à odeurs si la ventilation et les siphons ne sont pas suivis. Un réfectoire mélange graisses alimentaires et points de contact très sollicités — micro-ondes, poignées de frigo, robinetterie, tables.",
          "Nous les plaçons donc en début de passage, avec leur propre check-list et un matériel qui ne circule pas entre l’atelier et la zone de repas. C’est un détail d’organisation qui ne coûte rien et qui change ce que vos équipes constatent le matin.",
        ],
      },
    ],
    faq: [
      ...
      { q: 'Les vestiaires et le réfectoire sont-ils compris ?', a: "Oui, et nous les traitons en début de passage plutôt qu’avec le temps restant. Ce sont les locaux sur lesquels vos salariés jugent l’entretien, et ceux qui posent le plus de difficultés : humidité et odeurs côté vestiaires, graisses et points de contact côté réfectoire." },
      { q: 'Utilisez-vous le même matériel dans l’atelier et dans la zone de repas ?', a: "Non. Le matériel est différencié par zone et ne circule pas de l’un à l’autre. C’est une règle de base que la contrainte de temps fait souvent sauter chez d’autres, et elle n’est pas négociable chez nous." },
      { q: 'Faut-il un engagement de durée pour un petit local ?', a: "Non. Nous calons la fréquence sur votre besoin réel et vous gardez la main pour la faire évoluer. Un local de taille moyenne avec deux passages par semaine est un client normal, pas une exception que l’on tolère." },
    ],
  ...
  },
  {
    ...
    sections: [
      ...
      {
        h2: "Absorber un pic sans dégrader la prestation",
        paragraphs: [
          "Renforcer un passage un soir d’affluence pose une question que personne n’aime formuler : avec qui. La réponse facile consiste à envoyer des renforts recrutés pour la journée, qui découvrent les lieux en arrivant. Sur un local qu’ils ne connaissent pas, un soir où il y a le plus à faire, le résultat est prévisible.",
          "Nous prenons le problème à l’envers. Les intervenants qui viennent en renfort sont ceux qui connaissent déjà le site pour y passer en semaine ; le planning des dates connues est arrêté à l’avance, ce qui permet de réserver leurs disponibilités au lieu de les chercher la veille. L’encadrant présent est, lui aussi, quelqu’un qui a déjà travaillé sur place.",
          "C’est aussi pour cela que nous n’acceptons pas un renfort ponctuel sur un site que nous n’entretenons pas le reste du temps : ce serait vendre une intervention dont nous savons qu’elle sera moyenne.",
        ],
      },
      {
        h2: "Nos interventions sur la commune",
        list: [
          "Commerces, restauration et bars à cadence événementielle",
          "Bureaux et locaux professionnels du secteur",
          "Parties communes de copropriétés et de programmes récents",
          "Remise en état de logements avant relocation",
          "Livraison de logements neufs après travaux",
          "Renforts planifiés sur les week-ends de match ou de concert",
        ],
      },
    ],
    faq: [
      ...
      { q: 'Qui intervient lors des renforts d’affluence ?', a: "Les mêmes intervenants que le reste de la semaine. Nous ne complétons pas une équipe avec des personnes qui découvrent le site le soir où il y a le plus à faire : le planning événementiel étant connu à l’avance, nous réservons leurs disponibilités plutôt que de chercher quelqu’un la veille." },
      { q: 'Pouvez-vous venir uniquement les soirs d’événement ?', a: "Nous ne le proposons pas sur un site que nous n’entretenons pas par ailleurs. Sans connaissance des lieux, un passage renforcé donne un résultat moyen — autant vous le dire avant le devis plutôt qu’après." },
      { q: 'À quelle heure intervenez-vous le lendemain ?', a: "Avant l’ouverture, pour que le local soit rendu en état normal d’exploitation. L’ordre du passage est adapté : sanitaires et points de contact d’abord, sols de circulation ensuite, devanture pour finir." },
    ],
  ...
  },
  {
    ...
    sections: [
      ...
      {
        h2: "Une prestation régulière doit tenir toute l’année",
        paragraphs: [
          "Un entretien à domicile ne se juge pas sur les premières semaines. Il se juge le jour où l’intervenante habituelle est en congés, malade, ou change de poste — et c’est là que la plupart des arrangements informels s’arrêtent net. Le client se retrouve sans solution, souvent au pire moment de l’année.",
          "Nous organisons la continuité en amont plutôt qu’en urgence. Les particularités de la maison sont consignées : accès, alarme, pièces à ne pas traiter, produits à éviter sur tel matériau, habitudes que vous nous avez demandées. Un remplaçant arrive donc avec les consignes, pas avec un simple nom de rue.",
          "Nous prévenons aussi du remplacement à l’avance quand il est prévisible. Personne n’aime découvrir une personne inconnue sur son palier, surtout chez des clients qui nous confient leurs clés et sont absents pendant la prestation.",
        ],
      },
    ],
    faq: [
      ...
      { q: 'Que se passe-t-il si mon intervenante est absente ?', a: "Un remplacement est organisé, avec les consignes de votre maison consignées à l’avance : accès, alarme, pièces à ne pas traiter, produits à éviter sur tel matériau. Quand l’absence est prévisible, nous vous prévenons avant — personne n’aime découvrir quelqu’un d’inconnu sur son palier." },
  ...
  },
  {
    ...
    sections: [
      ...
      {
        h2: "Le sens de progression et le matériel par zone",
        paragraphs: [
          "Dans un local de santé, l’ordre du passage fait autant que les produits employés. On progresse du plus propre vers le plus sale — salle d’attente et bureaux d’abord, salles de soins ensuite, sanitaires en dernier — et jamais l’inverse. Un intervenant qui commence par les sanitaires puis remonte vers la salle de soins avec le même matériel a déplacé la contamination au lieu de la retirer.",
          "Le matériel suit la même logique : des lavettes et des franges différenciées par zone, identifiables d’un coup d’œil, changées entre les pièces et jamais replongées dans un seau commun. C’est la raison d’être des codes couleur, qui n’ont rien d’un gadget commercial — ils existent parce que personne ne se souvient, à la douzième pièce, de la lavette qu’il a utilisée où.",
          "Ces deux règles sont simples à énoncer et faciles à abandonner quand le temps manque. C’est précisément pour cela qu’un entretien de cabinet ne se comprime pas indéfiniment : passé un certain point, ce n’est plus une méthode, c’est un passage rapide qui en a l’apparence.",
        ],
      },
    ],
    faq: [
      ...
      { q: 'Dans quel ordre nettoyez-vous un cabinet ?', a: "Du plus propre vers le plus sale : salle d’attente et bureaux, puis salles de soins, sanitaires en dernier. L’inverse revient à déplacer la contamination d’une pièce à l’autre, même avec les bons produits." },
      { q: 'Changez-vous le matériel entre les pièces ?', a: "Oui, lavettes et franges sont différenciées par zone, identifiables par code couleur, changées entre les pièces et jamais replongées dans un seau commun. Le code couleur n’est pas un argument commercial : c’est ce qui rend la règle tenable à la douzième pièce." },
      { q: 'Pouvez-vous réduire la durée du passage pour baisser le coût ?', a: "Dans une certaine limite seulement. En dessous d’un certain temps, les temps de contact des désinfectants ne sont plus respectés et il n’y a plus de désinfection, seulement du nettoyage. Nous préférons le dire et ajuster la fréquence plutôt que la durée." },
    ],
  ...
  // ── Déclinaisons communales du cluster « fin de chantier » ────────────────
  {
    ...
    sections: [
      ...
      {
        h2: "Caler la livraison sur l’état des lieux d’entrée",
        paragraphs: [
          "Sur un appartement rénové pour la location, la date qui compte n’est pas la fin des travaux : c’est l’état des lieux d’entrée. C’est le moment où un locataire, souvent accompagné d’un agent, inspecte le logement en prenant des photos — et tout ce qu’il note ce jour-là se retrouve dans un document opposable pendant toute la durée du bail.",
          "Ce qu’il regarde est très prévisible. L’intérieur des placards et des tiroirs, le dessus des portes, les rails de baie, la bonde et le joint de douche, l’état du four et du réfrigérateur, les vitres à contre-jour. Ce sont exactement les points qu’un nettoyage de fin de chantier mené à la va-vite laisse de côté, parce qu’ils ne se voient pas quand on entre dans la pièce.",
          "Nous calons donc l’intervention au plus près de l’état des lieux, une fois toutes les entreprises parties, plutôt qu’à la fin des travaux. Un logement livré deux semaines trop tôt aura repris de la poussière de chantier redescendue des points hauts, et le locataire, lui, la verra.",
        ],
      },
    ],
    faq: [
      ...
      { q: 'Quand faut-il nous faire intervenir avant une mise en location ?', a: "Au plus près de l’état des lieux d’entrée, une fois toutes les entreprises parties — pas à la fin des travaux. Un logement livré deux semaines trop tôt aura repris la poussière redescendue des points hauts, et c’est le locataire qui la constatera." },
      { q: 'Traitez-vous l’intérieur des placards et de l’électroménager ?', a: "Oui, systématiquement. Intérieurs de placards et de tiroirs, dessus de portes, rails de baie, four et réfrigérateur : ce sont précisément les points inspectés lors d’un état des lieux, et ceux qu’un passage rapide laisse de côté." },
    ],
  ...
  },
  {
    ...
    sections: [
      ...
      {
        h2: "Les reprises qui repassent après nous",
        paragraphs: [
          "Sur une opération en volume, un lot est rarement fini le jour où on nous appelle. Il reste une reprise de peinture, un joint à refaire, une plinthe à reposer, un équipement à remplacer. Si le nettoyage passe avant ces reprises, il est à refaire — et cette fois personne ne veut le payer.",
          "Nous posons donc la question avant de planifier, lot par lot : qu’est-ce qui doit encore repasser, et quand. Quand des reprises sont inévitables après notre passage, nous le disons et nous prévoyons une reprise ciblée sur les zones concernées plutôt qu’un second nettoyage complet, qui n’aurait aucun sens économique.",
          "C’est une conversation de cinq minutes au moment du devis. Elle évite la situation la plus courante sur ce type d’opération : un maître d’ouvrage persuadé d’avoir fait nettoyer, un logement repassé par un peintre le lendemain, et un litige sur qui refait quoi.",
        ],
      },
    ],
    faq: [
      ...
      { q: 'Que se passe-t-il si des reprises interviennent après votre passage ?', a: "Nous posons la question avant de planifier, lot par lot. Quand une reprise est inévitable après nous, nous prévoyons une intervention ciblée sur les zones concernées plutôt qu’un second nettoyage complet — c’est la seule réponse qui tienne économiquement." },
      { q: 'Pouvez-vous livrer les lots au fil du planning plutôt qu’en une fois ?', a: "Oui, c’est même la règle sur ce type d’opération. Nous calons le nombre d’intervenants sur votre calendrier de remise, et chaque lot est contrôlé pièce par pièce avant d’être déclaré livré, avec son rapport d’intervention." },
    ],
  ...
  },
  {
    ...
    sections: [
      ...
      {
        h2: "Livrer un bâtiment logistique, une autre échelle",
        paragraphs: [
          "Le secteur compte beaucoup de bâtiments d’activité et d’entrepôts neufs, et leur livraison n’a pas grand-chose à voir avec celle d’un plateau de bureaux. La surface change la méthode : un dallage de plusieurs milliers de mètres carrés se traite en autolaveuse, pas à la frange, et le voile de ciment laissé par le coulage demande un produit adapté sous peine de rester visible une fois le sol sec.",
          "Les points hauts sont le second sujet. Charpente, chemins de câbles, sprinklers et luminaires accumulent une poussière de chantier qui redescendra sur le stock dès que la ventilation tournera. Y accéder suppose une nacelle et une coordination avec les autres intervenants encore sur site, pas une échelle et de la bonne volonté.",
          "Enfin, ces bâtiments se livrent souvent en coactivité : le racking se monte pendant que nous nettoyons. Nous découpons alors l’intervention par zones libérées plutôt que de promettre un bâtiment complet à une date où il ne le sera pas.",
        ],
      },
    ],
    faq: [
      ...
      { q: 'Traitez-vous les grandes surfaces de dallage ?', a: "Oui, en autolaveuse et avec un produit adapté au voile de ciment laissé par le coulage. Traité à la frange ou avec un détergent ordinaire, ce voile reste visible une fois le sol sec — et il se voit d’autant mieux que la surface est grande." },
      { q: 'Nettoyez-vous les points hauts d’un entrepôt ?', a: "Oui : charpente, chemins de câbles, sprinklers et luminaires. C’est un poste à part entière, parce que cette poussière redescend sur le stock dès que la ventilation tourne. Il demande une nacelle et une coordination avec les intervenants encore présents." },
      { q: 'Pouvez-vous intervenir pendant le montage du racking ?', a: "Oui, en découpant le bâtiment par zones libérées. Nous préférons livrer zone par zone plutôt que d’annoncer un bâtiment complet à une date où il ne le sera pas." },
    ],
  ...
  },
  {
    ...
    sections: [
      ...
      {
        h2: "Un chantier hors de l’agglomération, ce que ça change",
        paragraphs: [
          "Villefranche et le Beaujolais sont à une quarantaine de minutes de notre base lyonnaise. Ce n’est pas un obstacle, mais cela impose une façon de travailler différente : on ne repasse pas le lendemain pour la finition oubliée, et un aller-retour supplémentaire coûte une demi-journée à tout le monde.",
          "Nous organisons donc ces chantiers pour être traités en une seule venue. L’équipe est dimensionnée pour finir dans la journée quand c’est possible, le matériel est embarqué en conséquence — y compris ce qui ne sert qu’une fois sur dix, parce que le retour chercher un accessoire n’existe pas ici — et le contrôle final se fait sur place, avec vous ou avec les photos, avant que l’équipe ne reparte.",
          "C’est aussi pour cette raison que nous demandons systématiquement, avant de venir, si toutes les entreprises ont terminé. Sur un chantier lyonnais, arriver trop tôt coûte un contretemps. À Villefranche, cela coûte une journée.",
        ],
      },
    ],
    faq: [
      ...
      { q: 'Vous déplacez-vous dans tout le Beaujolais ?', a: "Oui, Villefranche, Anse et les communes alentour font partie de nos secteurs réguliers. Nous organisons ces chantiers pour être traités en une seule venue, avec une équipe dimensionnée pour finir dans la journée quand c’est possible." },
      { q: 'Faut-il que toutes les entreprises aient terminé avant votre passage ?', a: "Oui, et nous le vérifions avant de nous déplacer. Arriver avant la fin des travaux coûte un contretemps sur un chantier lyonnais ; ici, cela coûte une journée à tout le monde." },
      { q: 'Comment se passe la réception de l’intervention ?', a: "Le contrôle final se fait sur place avant que l’équipe ne reparte, avec vous si vous êtes présent, sinon avec les photos du rapport d’intervention. Nous ne repartons pas en laissant une réserve à traiter au prochain passage." },
    ],
  ...
  // ══════════════════════════════════════════════════════════════════════════
  {
    ...
    related: ['avance-immediate-credit-impot-menage', 'femme-de-menage-lyon', 'prix-menage-domicile-lyon', 'aide-menagere-domicile-lyon', 'repassage-domicile-lyon', 'menage-colocation-lyon'],
  ...
  },
  {
    ...
    cluster: 'particuliers',
    related: ['credit-impot-menage-domicile', 'aide-menagere-domicile-lyon', 'prix-menage-domicile-lyon', 'repassage-domicile-lyon', 'menage-colocation-lyon', 'menage-domicile-lyon'],
    relatedPosts: ['credit-impot-menage-erreurs-a-eviter'],
    updatedAt: '2026-09-05',
  },
  {
    ...
    cluster: 'particuliers',
    related: ['credit-impot-menage-domicile', 'avance-immediate-credit-impot-menage', 'femme-de-menage-lyon', 'menage-colocation-lyon', 'repassage-domicile-lyon', 'menage-domicile-lyon'],
    relatedPosts: ['choisir-societe-nettoyage-lyon'],
    updatedAt: '2026-09-05',
  },
  {
    ...
    cluster: 'particuliers',
    related: ['credit-impot-menage-domicile', 'avance-immediate-credit-impot-menage', 'aide-menagere-domicile-lyon', 'prix-menage-domicile-lyon', 'repassage-domicile-lyon', 'menage-colocation-lyon'],
    relatedPosts: ['checklist-menage-maison-hebdomadaire', 'choisir-societe-nettoyage-lyon'],
  ...
  },
  {
    ...
    cluster: 'particuliers',
    related: ['credit-impot-menage-domicile', 'avance-immediate-credit-impot-menage', 'femme-de-menage-lyon', 'repassage-domicile-lyon', 'menage-colocation-lyon', 'grand-menage-lyon'],
  ...
  },
  {
    ...
    cluster: 'particuliers',
    related: ['credit-impot-menage-domicile', 'avance-immediate-credit-impot-menage', 'aide-menagere-domicile-lyon', 'femme-de-menage-lyon', 'prix-menage-domicile-lyon', 'menage-colocation-lyon'],
    relatedPosts: ['checklist-menage-maison-hebdomadaire'],
    updatedAt: '2026-09-06',
  },
  {
    ...
    cluster: 'particuliers',
    related: ['credit-impot-menage-domicile', 'avance-immediate-credit-impot-menage', 'femme-de-menage-lyon', 'prix-menage-domicile-lyon', 'repassage-domicile-lyon', 'nettoyage-fin-de-bail-lyon'],
    relatedPosts: ['checklist-menage-maison-hebdomadaire'],
    updatedAt: '2026-09-06',
  },
  {
