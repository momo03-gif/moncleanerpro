...
export const BLOG_POSTS: BlogPost[] = [
  ...
  {
    slug: 'credit-impot-menage-erreurs-a-eviter',
    title: 'Crédit d’impôt ménage : 6 erreurs qui vous en privent',
    metaTitle: 'Crédit d’impôt ménage : les 6 erreurs à éviter',
    description: "Non imposable, Airbnb, plafond commun, prestataire non déclaré : les six erreurs qui font perdre le crédit d’impôt de 50 % sur le ménage à domicile.",
    keyword: 'crédit d’impôt ménage erreurs',
    date: '2026-09-06',
    readingMinutes: 6,
    body: [
      { type: 'p', text: "Le crédit d’impôt services à la personne rembourse la moitié de ce que vous dépensez pour l’entretien de votre logement. C’est l’un des dispositifs fiscaux les plus généreux qui existent pour un particulier — et l’un des plus mal utilisés. Voici les six erreurs que nous voyons revenir le plus souvent, et ce qu’elles coûtent réellement." },
      { type: 'h2', text: '1. Croire que ça ne sert à rien quand on n’est pas imposable' },
      { type: 'p', text: "C’est de loin l’erreur la plus répandue, et la plus coûteuse. Une réduction d’impôt vient effacer un impôt dû : sans impôt, elle ne sert effectivement à rien. Mais il s’agit ici d’un crédit d’impôt, ce qui est juridiquement autre chose : quand il dépasse ce que vous devez, la différence vous est versée." },
      { type: 'p', text: "Concrètement, un retraité non imposable qui fait entretenir son logement récupère bien la moitié de sa dépense. Chaque année, des foyers modestes renoncent à un service dont ils auraient eu besoin, sur la foi d’une phrase entendue de travers." },
      { type: 'h2', text: '2. Passer par quelqu’un qui n’est pas déclaré' },
      { type: 'p', text: "Le droit au crédit d’impôt n’est pas attaché à la prestation, mais à celui qui la réalise. Seules les sommes versées à un organisme de services à la personne agréé — ou à un salarié que vous employez en déclarant ses heures — y ouvrent droit." },
      { type: 'p', text: "Un tarif horaire proposé de la main à la main paraît toujours plus bas. Il se compare pourtant à une offre déclarée dont la moitié est prise en charge : une fois le calcul fait honnêtement, l’écart s’inverse presque toujours. Et il reste ce qu’on ne mesure qu’une fois que c’est arrivé — un accident domestique survenu chez vous pendant l’intervention engage votre responsabilité personnelle." },
      { type: 'h2', text: '3. Compter sur le crédit d’impôt pour son Airbnb' },
      { type: 'p', text: "C’est la confusion qui provoque le plus de déceptions, parce qu’elle ne se découvre qu’au moment de la déclaration. Le dispositif finance l’entretien de votre lieu de vie, pas votre activité. Un logement loué en meublé touristique relève de votre activité de location : le ménage y est une charge déductible de vos revenus locatifs, ce qui est un mécanisme entièrement différent." },
      { type: 'p', text: "La règle vaut aussi pour un local professionnel, un bureau ou un commerce. Votre résidence secondaire, en revanche, est bien éligible tant qu’elle n’est pas mise en location touristique." },
      { type: 'h2', text: '4. Oublier que le plafond est commun à tout le foyer' },
      { type: 'p', text: "L’avantage porte sur 12 000 € de dépenses par an et par foyer fiscal, soit 6 000 € de crédit — majorés de 1 500 € par enfant à charge ou par membre du foyer de plus de 65 ans, sans dépasser 15 000 €." },
      { type: 'p', text: "Le piège n’est pas le montant, c’est le mot « commun ». Un ménage hebdomadaire, de la garde d’enfants et du jardinage ne disposent pas de trois plafonds séparés : ils s’imputent tous sur la même enveloppe. Si vous employez déjà quelqu’un pour autre chose, cela vaut la peine d’en tenir compte avant d’augmenter la fréquence." },
      { type: 'h2', text: '5. Continuer à avancer la totalité' },
      { type: 'p', text: "Le fonctionnement historique voulait qu’on paie tout, puis qu’on attende la déclaration de revenus et le versement du fisc — parfois plus d’un an après. Ce n’est plus une fatalité : avec l’avance immédiate de l’URSSAF, vous ne réglez que la moitié au moment de la prestation, et l’autre moitié est versée directement au prestataire." },
      { type: 'p', text: "Le service est gratuit et l’inscription se fait une seule fois, avec votre numéro fiscal. Beaucoup de foyers y ont droit sans le savoir et continuent d’avancer une trésorerie dont ils n’ont aucune raison de se priver." },
      { type: 'h2', text: '6. Ne pas lire les notifications de prélèvement' },
      { type: 'p', text: "Avec l’avance immédiate, chaque montant vous est notifié avant d’être prélevé, et vous disposez d’une courte fenêtre pour le contester. C’est précisément le moment où une erreur se corrige facilement — après, il faut demander un remboursement." },
      { type: 'p', text: "Prenez l’habitude de vérifier deux choses : le montant correspond à ce qui était convenu, et la date correspond à une intervention qui a bien eu lieu. Dix secondes, et vous gardez la main sur ce qui part de votre compte." },
      ...
      { type: 'links', intro: 'Pour aller plus loin :', items: [
        ...
        { label: 'Avance immédiate du crédit d’impôt', href: '/avance-immediate-credit-impot-menage' },
        { label: 'Ménage à domicile à Lyon', href: '/menage-domicile-lyon' },
        { label: 'Prix d’un ménage à domicile à Lyon', href: '/prix-menage-domicile-lyon' },
      ] },
    ],
  },
  {
    slug: 'checklist-menage-maison-hebdomadaire',
    title: 'Checklist ménage maison : ce qui se fait chaque semaine, chaque mois, chaque saison',
    metaTitle: 'Checklist ménage maison : semaine, mois, saison',
    description: "La checklist du ménage à la maison, organisée par fréquence : le geste hebdomadaire, l’entretien mensuel et les tâches saisonnières qu’on oublie toujours.",
    keyword: 'checklist ménage maison',
    date: '2026-09-06',
    readingMinutes: 7,
    body: [
      { type: 'p', text: "La plupart des logements ne manquent pas de temps de ménage : ils manquent de rythme. On refait chaque semaine les mêmes surfaces visibles, pendant que d’autres ne sont jamais touchées — jusqu’au jour où elles demandent une intervention lourde. Organiser l’entretien par fréquence plutôt que par pièce règle ce déséquilibre, et réduit nettement le temps total passé." },
      { type: 'h2', text: 'Chaque semaine : tenir l’état, pas rattraper' },
      { type: 'p', text: "L’objectif du passage hebdomadaire n’est pas de tout nettoyer, c’est d’empêcher l’encrassement de s’installer. Une surface entretenue régulièrement se nettoie en quelques secondes ; la même surface laissée un mois demande un produit, du temps et parfois de l’huile de coude." },
      { type: 'ul', items: [
        "Sols de toutes les pièces : aspiration puis lavage",
        "Cuisine : plan de travail, évier, plaque, extérieur des équipements",
        "Salle de bains et WC : douche ou baignoire, lavabo, cuvette, désinfection",
        "Poussière sur les surfaces dégagées et les meubles bas",
        "Miroirs et robinetterie : les traces d’eau se voient plus que tout le reste",
        "Poubelles vidées, sacs remplacés",
        "Draps changés (toutes les une à deux semaines selon la saison)",
      ] },
      { type: 'h2', text: 'Chaque mois : ce qu’on ne voit pas depuis debout' },
      { type: 'p', text: "Ce sont les tâches qu’on remet indéfiniment parce qu’elles ne se voient pas au premier regard. Elles prennent peu de temps si elles sont faites tous les mois, et beaucoup si elles sont faites une fois par an." },
      { type: 'ul', items: [
        "Intérieur du micro-ondes et du four, joints de réfrigérateur",
        "Dessus des meubles hauts, cadres de porte, plinthes",
        "Interrupteurs, poignées et télécommandes (les points les plus touchés du logement)",
        "Filtre de la hotte et bac à lessive de la machine",
        "Sous les meubles déplaçables et derrière la porte des chambres",
        "Bondes de lavabo et de douche, avant qu’elles ne se bouchent",
      ] },
      { type: 'h2', text: 'Chaque saison : les gros postes' },
      { type: 'p', text: "Quatre fois par an suffit, et le moment le plus rentable est le changement de saison — quand on sort ou range de toute façon les affaires." },
      { type: 'ul', items: [
        "Vitres intérieures et extérieures accessibles, avec les encadrements",
        "Rideaux et voilages lavés, stores dépoussiérés",
        "Matelas aspiré et retourné, protège-matelas lavé",
        "Textiles d’ameublement : canapé, fauteuils, tapis",
        "Placards vidés, essuyés, réorganisés",
        "Radiateurs dépoussiérés avant la mise en route de l’hiver",
      ] },
      { type: 'h2', text: 'L’ordre qui fait gagner du temps' },
      { type: 'p', text: "Une règle simple change la durée d’un ménage complet : toujours du haut vers le bas, et des pièces propres vers les pièces sales. La poussière tombe, l’eau coule, et faire les sols avant les surfaces revient à les refaire deux fois." },
      { type: 'ul', items: [
        "Aérer en arrivant, dans toutes les pièces",
        "Ranger et dégager les surfaces avant de nettoyer quoi que ce soit",
        "Dépoussiérer du haut vers le bas",
        "Traiter cuisine et salle de bains, qui demandent du temps de pose",
        "Terminer par les sols, en finissant par la sortie",
      ] },
      { type: 'h2', text: 'Le désencombrement compte autant que le produit' },
      { type: 'p', text: "C’est le facteur le plus sous-estimé du temps de ménage. Sur un plan de travail couvert d’objets, l’essentiel du temps passe à déplacer puis remettre en place — pas à nettoyer. Un logement où les surfaces sont dégagées se fait en une fraction du temps, avec un meilleur résultat." },
      { type: 'p', text: "C’est aussi vrai quand quelqu’un intervient chez vous : dégager les surfaces avant le passage est le geste qui a le plus d’effet sur la durée de la prestation, donc sur son coût." },
      { type: 'h2', text: 'Quatre produits suffisent' },
      { type: 'p', text: "Le placard sous l’évier est l’endroit où l’on accumule le plus d’objets inutiles. La quasi-totalité d’un logement se traite avec quatre produits, et multiplier les flacons spécialisés coûte cher sans améliorer le résultat — surtout quand on en mélange deux par mégarde, ce qui peut être franchement dangereux." },
      { type: 'ul', items: [
        "Un dégraissant pour la cuisine : plan de travail, plaque, extérieur des équipements",
        "Un détartrant acide pour la salle de bains : douche, robinetterie, WC",
        "Un nettoyant multi-surfaces neutre pour le reste, y compris les sols courants",
        "De l’alcool ménager pour les vitres, les miroirs et l’inox, qui ne supportent pas les traces",
      ] },
      { type: 'p', text: "Deux règles valent plus que le choix de la marque : ne jamais mélanger un produit chloré avec un détartrant acide, et laisser le produit agir. Le temps de pose fait le travail à votre place — c’est le seul moment du ménage où ne rien faire est efficace." },
      { type: 'h2', text: 'Les erreurs qui font perdre le plus de temps' },
      { type: 'p', text: "Elles sont toujours les mêmes, et aucune n’a de rapport avec le manque d’application. Ce sont des erreurs de méthode : on travaille beaucoup, mais on refait deux fois ce qui aurait pu être fait une seule." },
      { type: 'ul', items: [
        "Nettoyer avant de ranger : chaque objet déplacé est une surface à refaire",
        "Faire les sols avant les surfaces, alors que la poussière tombe forcément dessus",
        "Rincer immédiatement après avoir pulvérisé, sans laisser le produit agir",
        "Utiliser un chiffon déjà saturé, qui étale au lieu d’absorber",
        "Traiter pièce par pièce de fond en comble, au lieu de regrouper les gestes identiques",
        "Attaquer une tache incrustée à sec, alors qu’un linge humide posé dix minutes la décolle seul",
      ] },
      { type: 'h2', text: 'Le passage express de vingt minutes' },
      { type: 'p', text: "Il y a les jours où l’on apprend une visite pour le soir même. Dans ce cas, l’objectif n’est pas de nettoyer, c’est de traiter ce que l’œil d’un invité capte réellement — et ce n’est pas ce qu’on croit. Personne n’inspecte vos plinthes ; tout le monde voit un évier plein et un miroir taché." },
      { type: 'ul', items: [
        "Aérer largement, c’est la première chose perçue en entrant",
        "Vider l’évier et dégager le plan de travail",
        "Passer un coup sur la lunette, le lavabo et le miroir de la salle de bains",
        "Ramasser ce qui traîne au sol dans les pièces de passage",
        "Vider la poubelle de la cuisine",
        "Passer l’aspirateur dans l’entrée et le salon uniquement",
      ] },
      { type: 'h2', text: 'Adapter selon votre logement' },
      { type: 'p', text: "La checklist par fréquence est une base, pas une règle universelle. Trois situations la déplacent nettement, et les ignorer explique la plupart des logements qui semblent sales malgré un entretien régulier." },
      { type: 'p', text: "Avec un animal, les poils imposent un passage d’aspirateur plus fréquent et un traitement des textiles remonté au mensuel plutôt qu’au saisonnier. En cas d’allergie aux acariens, la literie et les sols passent devant tout le reste : draps toutes les semaines, matelas aspiré chaque mois, et tapis réduits au minimum. Enfin, un logement peu ventilé — beaucoup d’appartements anciens lyonnais le sont — demande une vigilance sur les joints de salle de bains, où la moisissure s’installe en quelques semaines et devient ensuite très difficile à rattraper." },
      { type: 'links', intro: 'Pour aller plus loin :', items: [
        { label: 'Ménage à domicile à Lyon', href: '/menage-domicile-lyon' },
        { label: 'Grand ménage à Lyon', href: '/grand-menage-lyon' },
        { label: 'Femme de ménage à Lyon', href: '/femme-de-menage-lyon' },
        { label: 'Prix d’un ménage à domicile à Lyon', href: '/prix-menage-domicile-lyon' },
      ] },
    ],
  },
  {
    slug: 'changer-entreprise-nettoyage-sans-coupure',
    title: 'Changer d’entreprise de nettoyage sans trou de service',
    metaTitle: 'Changer d’entreprise de nettoyage : la méthode',
    description: "Comment changer de prestataire de nettoyage sans coupure : préavis, état des lieux, reprise du personnel, premières semaines. Le déroulé complet, étape par étape.",
    keyword: 'changer entreprise de nettoyage',
    date: '2026-09-13',
    readingMinutes: 6,
    body: [
      { type: 'p', text: "La plupart des entreprises insatisfaites de leur prestataire de nettoyage restent bien plus longtemps qu’elles ne le voudraient. La raison est presque toujours la même : la crainte d’un entre-deux mal géré, trois semaines de locaux à l’abandon pendant que la nouvelle équipe se met en place. Cette crainte est fondée, mais le risque se supprime — à condition de prendre les choses dans le bon ordre." },
      { type: 'h2', text: 'Commencez par relire votre contrat, pas par chercher un remplaçant' },
      { type: 'p', text: "C’est le réflexe inversé le plus coûteux. On consulte, on trouve mieux, on veut démarrer le mois suivant — et on découvre un préavis de trois mois, ou une tacite reconduction dont la fenêtre de dénonciation vient de se refermer. Vous vous retrouvez à payer deux prestataires, ou à faire patienter le nouveau jusqu’à ce qu’il ne soit plus disponible." },
      { type: 'p', text: "Vérifiez trois points avant tout le reste : la durée d’engagement restante, le délai de préavis, et la forme exigée pour la résiliation. Beaucoup de contrats imposent une lettre recommandée dans une fenêtre précise. Notez la date limite dans votre agenda, c’est elle qui fixe tout le calendrier qui suit." },
      { type: 'h2', text: 'Écrivez ce qui ne va pas, en tâches et en fréquences' },
      { type: 'p', text: "« Ce n’est pas propre » ne produira jamais un meilleur devis. Pendant deux ou trois semaines, notez précisément ce qui manque : les sanitaires repassés trop tard dans la journée, les vitres intérieures jamais faites, le local poubelles jamais inclus, les passages sautés le lundi. Vous obtiendrez une liste courte et très concrète." },
      { type: 'p', text: "Cette liste a deux usages. Elle vous dit si votre problème vient de la qualité d’exécution — auquel cas changer de prestataire le résoudra — ou du périmètre contractuel, auquel cas vous demandiez depuis le début quelque chose que personne ne vous avait vendu. Le second cas est plus fréquent qu’on ne le croit, et changer de prestataire ne le règle pas." },
      { type: 'h2', text: 'Faites visiter les locaux à chaque candidat' },
      { type: 'p', text: "Un prestataire qui chiffre à distance, sur une surface et un nombre de passages, vous propose un prix, pas une prestation. Deux plateaux identiques en surface ne demandent pas le même temps selon le nombre de postes, la nature du sol, la présence d’une cuisine partagée ou l’existence d’un vrai local ménage avec point d’eau." },
      { type: 'p', text: "La visite sert aussi à vous. C’est le moment où vous voyez si la personne en face regarde vraiment les lieux, pose des questions sur vos horaires et vos accès, ou se contente de compter les mètres carrés. Ce qu’elle fait pendant cette heure-là annonce assez bien ce que sera la relation." },
      { type: 'h2', text: 'Le point que personne ne vous dit : la reprise du personnel' },
      { type: 'p', text: "Dans la propreté, les salariés affectés à un site peuvent, sous conditions d’ancienneté et d’affectation, être repris par le prestataire entrant au titre de la convention collective du secteur. Autrement dit : changer d’entreprise ne signifie pas nécessairement changer de personne sur le terrain." },
      { type: 'p', text: "Ce n’est ni une bonne ni une mauvaise nouvelle en soi, mais il faut le savoir avant de signer. Si votre insatisfaction porte sur l’encadrement, l’organisation et le suivi, la reprise est plutôt un atout : la personne connaît vos locaux. Si elle porte sur l’intervenant lui-même, il faut en parler franchement avec le prestataire entrant dès la consultation, pas le découvrir le premier lundi." },
      { type: 'h2', text: 'Séparez la remise à niveau de l’entretien courant' },
      { type: 'p', text: "C’est l’erreur qui plombe le plus de transitions. Un prestataire sortant relâche souvent l’effort sur ses dernières semaines, et les locaux accumulent un retard invisible : sols non repris, hauteurs jamais faites, sanitaires dégradés. La nouvelle équipe arrive, passe trois semaines à rattraper cet arriéré avec le temps prévu pour l’entretien courant — et vous en concluez qu’elle ne tient pas la cadence." },
      { type: 'p', text: "La parade est simple : faire un état des lieux avant le démarrage, lister ce qui relève du retard, et le traiter comme une prestation à part, une fois. Ensuite seulement l’entretien courant commence sur une base saine. Un prestataire sérieux vous le proposera de lui-même ; s’il ne le fait pas, proposez-le." },
      { type: 'h2', text: 'Réglez les accès avant la date, pas le jour même' },
      { type: 'p', text: "Clés, badges, codes, alarme, étage, digicode du local poubelles, horaires de l’immeuble : c’est ce qui fait échouer le premier passage dans la grande majorité des cas. Tout doit être remis et testé avant le démarrage, avec le nom de la personne à joindre si quelque chose ne fonctionne pas à six heures du matin." },
      { type: 'p', text: "Pensez aussi à récupérer les clés du sortant le jour de son dernier passage, et à faire changer un code partagé. Cela paraît évident et c’est très régulièrement oublié." },
      { type: 'h2', text: 'Les quatre premières semaines' },
      { type: 'ul', items: [
        "Semaine 1 : un point rapide en fin de semaine, sur les écarts constatés uniquement. C’est normal qu’il y en ait, le site se découvre.",
        "Semaine 2 : vérifiez que les corrections de la semaine 1 ont bien été intégrées. Un écart signalé deux fois sans effet est le seul vrai signal d’alarme.",
        "Semaine 4 : point de calage sur le périmètre. C’est le bon moment pour ajuster une fréquence, ajouter une zone oubliée, décaler un horaire.",
        "Ensuite : un point trimestriel suffit, à condition d’avoir une trace écrite de chaque passage à consulter entre-temps.",
      ] },
      { type: 'p', text: "Une transition bien menée se joue sur ces quatre semaines. Passé ce cap, la relation est installée — dans un sens ou dans l’autre." },
      { type: 'links', intro: 'Pour aller plus loin :', items: [
        ...
        { label: 'prix du nettoyage de bureaux à Lyon', href: '/prix-nettoyage-bureaux-lyon' },
      ] },
      { type: 'p', text: "Vous envisagez un changement de prestataire à Lyon ou dans la métropole ? Nous faisons la visite des locaux et l’état des lieux avant toute date de démarrage, et le devis écrit vous parvient sous 24h." },
    ],
  },
];
