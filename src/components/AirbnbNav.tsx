...
const navItems = [
  { href: '/airbnb', label: 'Appartements', icon: '⬡' },
  { href: '/airbnb/missions', label: 'Missions', icon: '◎' },
];
    ...
    <>
      <header className="flex items-center justify-between px-5 py-4 border-b sticky top-0 z-20" style={{ backgroundColor: '#FAFAF8', borderColor: '#E8E4DC' }}>
        ...
        <div className="flex items-center gap-2">
          ...
          <button onClick={handleLogout} className="text-xs px-3 py-2 rounded-xl shrink-0 min-h-[36px]" style={{ backgroundColor: '#F5F3EF', color: '#7A7068' }}>
            Sortir
          </button>
        </div>
      </header>
